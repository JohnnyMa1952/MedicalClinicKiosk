...
int main(void)
{
	printf("Start\n");
	Clear(BLUE);
	OutGraphicsString((Point){10, 40}, WHITE, RED, "Johnny Ma!", 0, 1, 1);
	OutGraphicsString((Point){10, 60}, WHITE, RED, "Johnny Ma!", 0, 2, 1);
	OutGraphicsString((Point){10, 150}, WHITE, RED, "Johnny Ma!", 1, 3, 1);
	OutGraphicsString((Point){10, 200}, WHITE, RED, "Johnny Ma!", 0, 4, 1);
	OutGraphicsString((Point){10, 300}, WHITE, RED, "Johnny Ma!", 1, 5, 1);
	printf("Done\n");
	return 0;
}*/
