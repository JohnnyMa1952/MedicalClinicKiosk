...
#define REDRAW_THIS_ON_RELEASE 		4
#define REDRAW_ALL_ON_RELEASE 		7
#define RESET_GUI_STATE				5
#define KILL_GUI					6
#define RELEASE_CHANGE_SCREEN_TWO_NEXT 	8
...
unsigned char dummy(void); // function to pass as argument for inviable buttons and other similar situations
