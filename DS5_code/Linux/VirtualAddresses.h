...
//	Biomed
#define ipod_ReceiverFifo					(*(volatile unsigned char *)(virtual_base + ((0xFF210220)&(HW_REGS_MASK))))
#define ipod_TransmitterFifo				(*(volatile unsigned char *)(virtual_base + ((0xFF210220)&(HW_REGS_MASK))))
#define ipod_InterruptEnableReg			(*(volatile unsigned char *)(virtual_base + ((0xFF210222)&(HW_REGS_MASK))))
#define ipod_InterruptIdentificationReg	(*(volatile unsigned char *)(virtual_base + ((0xFF210224)&(HW_REGS_MASK))))
#define ipod_FifoControlReg				(*(volatile unsigned char *)(virtual_base + ((0xFF210224)&(HW_REGS_MASK))))
#define ipod_LineControlReg				(*(volatile unsigned char *)(virtual_base + ((0xFF210226)&(HW_REGS_MASK))))
#define ipod_ModemControlReg				(*(volatile unsigned char *)(virtual_base + ((0xFF210228)&(HW_REGS_MASK))))
#define ipod_LineStatusReg					(*(volatile unsigned char *)(virtual_base + ((0xFF21022A)&(HW_REGS_MASK))))
#define ipod_ModemStatusReg				(*(volatile unsigned char *)(virtual_base + ((0xFF21022C)&(HW_REGS_MASK))))
#define ipod_ScratchReg					(*(volatile unsigned char *)(virtual_base + ((0xFF21022E)&(HW_REGS_MASK))))
#define ipod_DivisorLatchLSB				(*(volatile unsigned char *)(virtual_base + ((0xFF210220)&(HW_REGS_MASK))))
#define ipod_DivisorLatchMSB				(*(volatile unsigned char *)(virtual_base + ((0xFF210222)&(HW_REGS_MASK))))
